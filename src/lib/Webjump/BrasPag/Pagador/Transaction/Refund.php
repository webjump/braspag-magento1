 ...
 **/
class Webjump_BrasPag_Pagador_Transaction_Refund extends Webjump_BrasPag_Core_Http_Client
    implements Webjump_BrasPag_Pagador_TransactionInterface
{
    ...
    /**
     * @param Webjump_BrasPag_Pagador_Transaction_Refund_ResponseInterface $response
     * @return $this
     */
