...
class Webjump_BrasPag_Pagador_Transaction_Capture_Request_Hydrator
    extends Webjump_BrasPag_Core_Hydrator_Abstract
    implements Webjump_BrasPag_Pagador_Transaction_Capture_Request_HydratorInterface
{
    /**
     * @param array $data
     * @param Webjump_BrasPag_Pagador_Transaction_Capture_RequestInterface $request
     * @return Webjump_BrasPag_Pagador_Transaction_Capture_RequestInterface
     */
	public function hydrate(array $data, Webjump_BrasPag_Pagador_Transaction_Capture_RequestInterface $request)
	{
     ...
     * @return mixed
     */
	protected function hydrateDefault(array $data, Webjump_BrasPag_Pagador_Transaction_Capture_RequestInterface $request)
	{
     ...
     * @return mixed
     */
	protected function hydrateOrder(array $data, Webjump_BrasPag_Pagador_Transaction_Capture_RequestInterface $request)
	{
     ...
     * @return mixed
     */
	protected function hydratePayment(array $data, Webjump_BrasPag_Pagador_Transaction_Capture_RequestInterface $request)
	{
     ...
     * @return mixed
     */
	protected function hydrateCustomer(array $data, Webjump_BrasPag_Pagador_Transaction_Capture_RequestInterface $request)
	{
