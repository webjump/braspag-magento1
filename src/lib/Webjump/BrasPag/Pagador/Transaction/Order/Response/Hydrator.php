...
class Webjump_BrasPag_Pagador_Transaction_Order_Response_Hydrator
    implements Webjump_BrasPag_Pagador_Transaction_Order_Response_HydratorInterface
{
    ...
    /**
     * Webjump_BrasPag_Pagador_Transaction_Order_Response_Hydrator constructor.
	...
	public function hydrate(
        ...
        Webjump_BrasPag_Pagador_Transaction_Order_ResponseInterface $response
    ){
	...
	protected function getPaymentTypeByDataResponse($paymentDataResponse)
	{
		switch ($paymentDataResponse->getData('Type')) {
			case 'Boleto':
        	    return $this->getServiceManager()->get('Pagador\Data\Response\Payment\Billet');
        	    break;
