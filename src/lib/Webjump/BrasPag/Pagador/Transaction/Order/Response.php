 ...
 **/
class Webjump_BrasPag_Pagador_Transaction_Order_Response
    extends Webjump_BrasPag_Core_Data_Abstract
    implements Webjump_BrasPag_Pagador_Transaction_Order_ResponseInterface
{
    protected $paymentId;
    protected $success;
