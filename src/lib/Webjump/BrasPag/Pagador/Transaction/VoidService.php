 ...
 **/
class Webjump_BrasPag_Pagador_Transaction_VoidService implements Webjump_BrasPag_Core_Service_Interface
{
    public function getServices()
    {
        return array(
            ...
            'Pagador\Transaction\Void\Request\Builder' => function ($serviceManager) {
                return new Webjump_BrasPag_Pagador_Transaction_Void_Request_Builder($serviceManager);
            },

            'Pagador\Transaction\Void\Response\Hydrator' => function ($serviceManager) {
                return new Webjump_BrasPag_Pagador_Transaction_Void_Response_Hydrator($serviceManager);
            }
        );
    }
}
