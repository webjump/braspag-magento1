...
class Webjump_BrasPag_Pagador_Transaction_Authorize_RequestHydrator implements Webjump_BrasPag_Pagador_Data_HydratorInterface
{
	...
	protected function hydrateDefault(array $data, Webjump_BrasPag_Pagador_Transaction_Authorize_RequestInterface $request)
	{
	...
	protected function hydrateOrder(array $data, Webjump_BrasPag_Pagador_Transaction_Authorize_RequestInterface $request)
	{
	...
	protected function hydratePayment(array $data, Webjump_BrasPag_Pagador_Transaction_Authorize_RequestInterface $request)
	{
	...
	protected function hydrateCustomer(array $data, Webjump_BrasPag_Pagador_Transaction_Authorize_RequestInterface $request)
	{
