...
class Webjump_BrasPag_Pagador_Transaction_Authorize_Request_Hydrator extends Webjump_BrasPag_Core_Hydrator_Abstract
    implements Webjump_BrasPag_Pagador_Transaction_Authorize_Request_HydratorInterface
{
    /**
     * @param array $data
     * @param Webjump_BrasPag_Pagador_Transaction_Authorize_RequestInterface $request
     * @return Webjump_BrasPag_Pagador_Transaction_Authorize_RequestInterface
     */
	...
	protected function hydrateDefault(
	    array $data, Webjump_BrasPag_Pagador_Transaction_Authorize_RequestInterface $request
    ) {
