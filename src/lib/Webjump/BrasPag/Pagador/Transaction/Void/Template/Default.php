<?php
/**
 * Pagador Transaction Void Template Default
 *
 * @category  Template
 * @package   Webjump_BrasPag_Pagador_Transaction_Void_Template
 * @author    Webjump Core Team <desenvolvedores@webjump.com>
 * @copyright 2019 Webjump (http://www.webjump.com.br)
 * @license   http://www.webjump.com.br  Copyright
 * @link      http://www.webjump.com.br
 **/
class Webjump_BrasPag_Pagador_Transaction_Void_Template_Default
{
    protected $request;
    protected $data;
