 ...
 **/
class Webjump_BrasPag_Pagador_Data_Request_Transaction_Current extends Webjump_BrasPag_Pagador_Data_Abstract implements Webjump_BrasPag_Pagador_Data_Request_Transaction_CurrentInterface
{
    private $transaction;
