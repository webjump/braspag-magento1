<?php
//
//class Webjump_BrasPag_Pagador_Service_Client implements Webjump_BrasPag_Pagador_Service_ClientInterface
//{
...
//     * @var int
//     */
//    protected $soapVersion = self::VERSION_1_2;
//
//    /**
//     * @var array
//     */
...
//     * @return self
//     * @throws Exception with invalid soap version argument
//     */
//    public function setSoapVersion($version)
//    {
//        if (!in_array($version, array(self::VERSION_1_1, self::VERSION_1_2))) {
//            throw new Exception(
//                'Invalid soap version specified. Use VERSION_1_1 or VERSION_1_2 constants.'
//            );
//        }
//
...
//     * @return self
//     * @throws Exception for any invalid class in the class map
//     */
//    public function setClassmap(array $classmap)
//    {
//        foreach ($classmap as $class) {
//            if (!class_exists($class)) {
//                throw new Exception('Invalid class in class map: ' . $class);
//            }
//        }
//
...
//                throw new Exception('Invalid from_xml callback for type: ' . $type['type_name']);
//            }
//            if (!is_callable($type['to_xml'])) {
//                throw new Exception('Invalid to_xml callback for type: ' . $type['type_name']);
//            }
//        }
//
...
//     * @return self
//     * @throws Exception with invalid encoding argument
//     */
...
//     * @param  string $urn
//     * @return bool
//     * @throws Exception on invalid URN
//     */
...
//     * @param  string $uri
//     * @return self
//     * @throws Exception with invalid uri argument
//     */
...
//     * @return self
//     * @throws Exception with invalid style argument
//     */
...
//     * @return self
//     * @throws Exception with invalid message encoding method argument
//     */
...
//     * @return self
//     * @throws Exception with invalid local certificate path argument
//     */
...
//     *
//     * @param  Webjump_BrasPag_Pagador_Service_Client_Common $client
...
//     * @return mixed
//     */
//    public function _doRequest(Webjump_BrasPag_Pagador_Service_Client_Common $client, $request, $location, $action, $version, $oneWay = null)
//    {
...
//        unset($options['wsdl']);
//
//        $this->soapClient = new Webjump_BrasPag_Pagador_Service_Client_Common(array($this, '_doRequest'), $wsdl, $options);
//    }
//
//    /**
