 ...
 **/
class Webjump_BrasPag_PagadorQuery_Transaction_GetByPaymentId_Response
    extends Webjump_BrasPag_Core_Data_Abstract
    implements Webjump_BrasPag_PagadorQuery_Transaction_GetByPaymentId_ResponseInterface
{
    protected $paymentId;
    protected $success;
    ...
    public function setPayment(Webjump_BrasPag_PagadorQuery_Data_Response_Payment_Current $payment = null)
    {
