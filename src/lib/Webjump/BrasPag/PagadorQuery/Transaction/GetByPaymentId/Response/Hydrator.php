...
class Webjump_BrasPag_PagadorQuery_Transaction_GetByPaymentId_Response_Hydrator
    implements Webjump_BrasPag_PagadorQuery_Transaction_GetByPaymentId_Response_HydratorInterface
{
    ...
    /**
     * Webjump_BrasPag_PagadorQuery_Transaction_GetByPaymentId_Response_Hydrator constructor.
	...
	public function hydrate(
        ...
        Webjump_BrasPag_PagadorQuery_Transaction_GetByPaymentId_ResponseInterface $response
    ){
	...
	protected function getPaymentTypeByDataResponse($paymentDataResponse)
	{
		switch ($paymentDataResponse->getData('Type')) {
			case 'Boleto':
        	    return $this->getServiceManager()->get('PagadorQuery\Data\Response\Payment\Billet');
        	    break;
        	
        	case 'CreditCard':
        	    return $this->getServiceManager()->get('PagadorQuery\Data\Response\Payment\CreditCard');
        	    break;
        	
        	case 'DebitCard':
        	    return $this->getServiceManager()->get('PagadorQuery\Data\Response\Payment\DebitCard');
        	    break;
    ...
    /**
     * @return Webjump_BrasPag_PagadorQuery_Service_ServiceManagerInterface
     */
