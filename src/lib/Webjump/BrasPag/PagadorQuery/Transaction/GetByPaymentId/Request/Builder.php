<?php
/**
 * Pagador Transaction GetByPaymentId Template Default
 *
 * @category  Template
 * @package   Webjump_BrasPag_PagadorQuery_Transaction_GetByPaymentId_Template
 * @author    Webjump Core Team <desenvolvedores@webjump.com>
 * @copyright 2019 Webjump (http://www.webjump.com.br)
 * @license   http://www.webjump.com.br  Copyright
 * @link      http://www.webjump.com.br
 **/
class Webjump_BrasPag_PagadorQuery_Transaction_GetByPaymentId_Request_Builder
    implements Webjump_BrasPag_Core_Builder_Interface
{
    ...
    public function getPaymentData()
    {
        ...
        if ($payment instanceof Webjump_BrasPag_PagadorQuery_Data_Request_Payment_CreditCardInterface) {

            return $this->getCreditCardData($payment);
        } elseif ($payment instanceof Webjump_BrasPag_PagadorQuery_Data_Request_Payment_DebitCardInterface) {

            return $this->getDebitCardData($payment);
        } elseif ($payment instanceof Webjump_BrasPag_PagadorQuery_Data_Request_Payment_BilletInterface) {

            return $this->getBilletData($payment);
        } else {
     ...
     * @return array
     */
    protected function getBilletData($payment)
    {
        return [
            "Provider" => $payment->getProvider(),
            "Type" => $payment->getType(),
            "Amount" => $payment->getAmount(),
            "BilletNumber" => $payment->getBilletNumber(),
