 ...
 **/
class Webjump_BrasPag_PagadorQuery_Data_Request_Order extends Webjump_BrasPag_Core_Data_Abstract
    implements Webjump_BrasPag_PagadorQuery_Data_Request_OrderInterface
{
