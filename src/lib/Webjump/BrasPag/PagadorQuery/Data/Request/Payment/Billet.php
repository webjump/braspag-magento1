 ...
 **/
class Webjump_BrasPag_PagadorQuery_Data_Request_Payment_Billet
    extends Webjump_BrasPag_PagadorQuery_Data_Request_Payment_Abstract
    implements Webjump_BrasPag_PagadorQuery_Data_Request_Payment_BilletInterface
{
