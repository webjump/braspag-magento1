...
class Webjump_Abbreviation {

    private $street;
    private $number;
    private $complement;
    private $abbreviationList;
    private $abbreviationSize;
    private $abbreviationLimit = 40;
    private $abbreviationStreetPercentage = 90;
    private $abbreviationComplementPercentage = 10;
    ...
    private function getAbbreviationOthers() {
        $others = array(
            'ACADEMICO' => 'ACD',
            'ADVOGADO' => 'ADV',
            'ALFERES' => 'ALF',
    ...
    private function abbreviationPlaces($string) {
    ...
    private function prepareAbbreviation() {
    ...
    private function abbreviateMore($string)
    {
        $string_array = explode(' ', $string);
        $stringReturn = array();
    ...
    private function cutForAbbreviate($string, $percentage, $roundUp = false)
    {
