...
class Braspag_Lib_PagadorQuery_Transaction_GetPayment_ByPaymentId_Response_Hydrator
    implements Braspag_Lib_PagadorQuery_Transaction_GetPayment_ByPaymentId_Response_HydratorInterface
{
    ...
    /**
     * Braspag_Lib_PagadorQuery_Transaction_GetPayment_ByPaymentId_Response_Hydrator constructor.
	...
	public function hydrate(
        ...
        Braspag_Lib_PagadorQuery_Transaction_GetPayment_ByPaymentId_ResponseInterface $response
    ){
