 ...
 **/
class Braspag_Lib_PagadorQuery_Transaction_GetPayment_ByPaymentId_Response
    extends Braspag_Lib_Core_Data_Abstract
    implements Braspag_Lib_PagadorQuery_Transaction_GetPayment_ByPaymentId_ResponseInterface
{
    protected $paymentId;
    protected $success;
    ...
    public function setOrder(Braspag_Lib_Pagador_Data_Response_Order $order)
    {
        $this->order = $order;
