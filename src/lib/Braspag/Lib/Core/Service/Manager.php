 ...
 **/
class Braspag_Lib_Core_Service_Manager
    implements Braspag_Lib_Core_Service_ManagerInterface
{
    ...
    {
        $this->serviceManagerModel = Mage::getModel('braspag_core/serviceManager');

        $this->config = new Braspag_Lib_Core_Service_Config($config);
    ...
    /**
     * @return Braspag_Lib_Core_Service_Config
     */
