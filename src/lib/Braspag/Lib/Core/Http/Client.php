 ...
 * @package   Braspag_Lib_Pagador_Transaction
 * @author    Webjump Core Team <desenvolvedores@webjump.com>
 * @copyright 2019 Webjump (http://www.webjump.com.br)
 * @license   http://www.webjump.com.br  Copyright
 * @link      http://www.webjump.com.br
 **/
class Braspag_Lib_Core_Http_Client extends \Zend_Http_Client
{
    protected $namespace;
    protected $request;
    protected $response;
    ...
    const CONFIG_NAMESPACE_KEY = 'webservice_url';

    /**
     * Braspag_Lib_Core_Http_Client constructor.
    ...
    protected function prepareResponse($response)
    {
        ...
        return $this->getResponseHydrator()->hydrate($responseData, $response);
    }
