...
class Braspag_Lib_Core_Auth_GetToken_Response_Hydrator
    implements Braspag_Lib_Core_Auth_GetToken_Response_HydratorInterface
{
    ...
    /**
     * Braspag_Lib_Core_Auth_GetToken_ResponseHydrator constructor.
     * @param Braspag_Lib_Core_Service_ServiceManagerInterface $serviceManager
     */
     ...
     * @param Braspag_Lib_Core_Auth_GetToken_ResponseInterface $response
     * @return $this
     * @throws Exception
     */
    ...
    /**
     * @return Braspag_Lib_Core_Service_ServiceManagerInterface
     */
