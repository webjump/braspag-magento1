<?php
//class Braspag_Lib_PagadorQuery extends \Zend_Http_Client
//{
...
//            ];
//
//            $this->setUri($config['webservice_url']."v2/sales/");
//            $this->setMethod("GET");
...
//            ];
//
//            $this->setUri($config['webservice_url']."v2/sales/".$dataRequest['PaymentId']);
//            $this->setMethod("GET");
//
//            $this->setHeaders('Content-Type', 'application/json');
//            $this->setHeaders($dataRequest['Header']);
