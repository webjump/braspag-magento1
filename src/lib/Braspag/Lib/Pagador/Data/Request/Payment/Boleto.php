 ...
 **/
class Braspag_Lib_Pagador_Data_Request_Payment_Boleto
    extends Braspag_Lib_Pagador_Data_Request_Payment
    implements Braspag_Lib_Pagador_Data_Request_Payment_BoletoInterface
{
    ...
    const METHOD = 'Braspag_Lib_boleto';
    const TYPE = 'Boleto';
