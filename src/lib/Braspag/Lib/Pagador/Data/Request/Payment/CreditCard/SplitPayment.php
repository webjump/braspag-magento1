 ...
 **/
class Braspag_Lib_Pagador_Data_Request_Payment_CreditCard_SplitPayment
    extends Braspag_Lib_Core_Data_Abstract
    implements Braspag_Lib_Pagador_Data_Request_Payment_CreditCard_SplitPaymentInterface
{
