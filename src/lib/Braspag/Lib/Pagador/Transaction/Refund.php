 ...
 * @package   Braspag_Lib_Pagador_Transaction_Refund
 * @author    Webjump Core Team <desenvolvedores@webjump.com>
 * @copyright 2019 Webjump (http://www.webjump.com.br)
 * @license   http://www.webjump.com.br  Copyright
 * @link      http://www.webjump.com.br
 **/
class Braspag_Lib_Pagador_Transaction_Refund extends Braspag_Lib_Core_Http_Client
    implements Braspag_Lib_Pagador_TransactionInterface
{
     ...
     * @return $this
     */
    public function setRequest(Braspag_Lib_Pagador_Transaction_Refund_RequestInterface $request)
    {
     ...
     * @return $this
     */
    public function setResponse(Braspag_Lib_Pagador_Transaction_Refund_ResponseInterface $response)
    {
    ...
    protected function getRequestBuilder()
    {
        if (!$this->requestBuilder) {
            $this->requestBuilder = $this->getServiceManager()->get('Pagador\Transaction\Refund\Request\Builder');
        }
    ...
    protected function getResponseHydrator()
    {
        if (!$this->responseHydrator) {
            $this->responseHydrator = $this->getServiceManager()->get('Pagador\Transaction\Refund\Response\Hydrator');
        }
