 ...
 * @package   Braspag_Lib_Pagador_Transaction_Order
 * @author    Webjump Core Team <desenvolvedores@webjump.com>
 * @copyright 2019 Webjump (http://www.webjump.com.br)
 * @license   http://www.webjump.com.br  Copyright
 * @link      http://www.webjump.com.br
 **/
class Braspag_Lib_Pagador_Transaction_Order extends Braspag_Lib_Core_Http_Client
    implements Braspag_Lib_Pagador_TransactionInterface
{
     ...
     * @return $this
     */
    public function setResponse(Braspag_Lib_Pagador_Transaction_Order_ResponseInterface $response)
    {
