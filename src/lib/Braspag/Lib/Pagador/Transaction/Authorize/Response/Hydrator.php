...
class Braspag_Lib_Pagador_Transaction_Authorize_Response_Hydrator
    implements Braspag_Lib_Pagador_Transaction_Authorize_Response_HydratorInterface
{
    ...
    /**
     * Braspag_Lib_Pagador_Transaction_Authorize_Response_Hydrator constructor.
     ...
     * @param Braspag_Lib_Pagador_Transaction_Authorize_ResponseInterface $response
     * @return $this
     * @throws Exception
     */
	public function hydrate(
	    \Zend_Http_Response $data,
        Braspag_Lib_Pagador_Transaction_Authorize_ResponseInterface $response
    ){
