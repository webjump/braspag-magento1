...
class Braspag_Lib_Pagador_Transaction_Authorize_Request_Hydrator extends Braspag_Lib_Core_Hydrator_Abstract
    implements Braspag_Lib_Pagador_Transaction_Authorize_Request_HydratorInterface
{
    /**
     * @param array $data
     * @param Braspag_Lib_Pagador_Transaction_Authorize_RequestInterface $request
     * @return Braspag_Lib_Pagador_Transaction_Authorize_RequestInterface
     */
	...
	protected function hydrateDefault(
	    array $data, Braspag_Lib_Pagador_Transaction_Authorize_RequestInterface $request
    ) {
