...
class Braspag_Lib_Pagador_Transaction_Capture_Response_Hydrator
    implements Braspag_Lib_Pagador_Transaction_Capture_Response_HydratorInterface
{
    ...
    /**
     * Braspag_Lib_Pagador_Transaction_Capture_Response_Hydrator constructor.
