 ...
 **/
class Braspag_Lib_Pagador_Transaction_Authorize extends Braspag_Lib_Core_Http_Client
    implements Braspag_Lib_Pagador_TransactionInterface
{
     ...
     * @return $this
     */
    public function setResponse(Braspag_Lib_Pagador_Transaction_Authorize_ResponseInterface $response)
    {
