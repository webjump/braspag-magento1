...
class Braspag_Lib_Pagador_Transaction_Void_Request_Hydrator
    extends Braspag_Lib_Core_Hydrator_Abstract
    implements Braspag_Lib_Pagador_Transaction_Void_Request_HydratorInterface
{
    /**
     * @param array $data
     * @param Braspag_Lib_Pagador_Transaction_Void_RequestInterface $request
     * @return Braspag_Lib_Pagador_Transaction_Void_RequestInterface
     */
     ...
     * @return mixed
     */
    protected function hydrateDefault(array $data, Braspag_Lib_Pagador_Transaction_Void_RequestInterface $request)
    {
     ...
     * @return mixed
     */
    protected function hydrateOrder(array $data, Braspag_Lib_Pagador_Transaction_Void_RequestInterface $request)
    {
     ...
     * @return mixed
     */
    protected function hydratePayment(array $data, Braspag_Lib_Pagador_Transaction_Void_RequestInterface $request)
    {
     ...
     * @return mixed
     */
    protected function hydrateCustomer(array $data, Braspag_Lib_Pagador_Transaction_Void_RequestInterface $request)
    {
