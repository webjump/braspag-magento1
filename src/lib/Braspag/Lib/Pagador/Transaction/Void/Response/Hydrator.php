...
class Braspag_Lib_Pagador_Transaction_Void_Response_Hydrator
    implements Braspag_Lib_Pagador_Transaction_Void_Response_HydratorInterface
{
    ...
    /**
     * Braspag_Lib_Pagador_Transaction_Void_Response_Hydrator constructor.
