 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_ProtectedCard_Model_Transaction_Resource_Authorize_CreditCardJustClick_Request_Builder
    extends Braspag_Pagador_Model_Transaction_AbstractBuilder
{
    ...
    public function build($payment, $amount)
    {
        ...
        $requestBuilderCompositeData = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/authorize/credit_card_just_click/request/builder');
        ...
        $requestData = array(
            ...
            'customer' 	=> $requestDataBuilder->getData('Customer')
        );
