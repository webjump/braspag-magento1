 ...
 *
 * @category  Model
 * @package   Braspag_ProtectedCard_Model_Method
 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_ProtectedCard_Model_Method_CreditCardJustClick
    extends Braspag_Pagador_Model_Method_Abstract
{
    protected $_code = Braspag_ProtectedCard_Model_Config::METHOD_JUSTCLICK;
    protected $_formBlockType = 'braspag_protectedcard/payment_form_method_creditCardJustClick';
    ...
    public function assignData($data)
    {
        ...
        if ($this->getCode() != Braspag_ProtectedCard_Model_Config::METHOD_JUSTCLICK) {
    ...
    public function authorize(Varien_Object $payment, $amount)
    {
        ...
        Mage::getModel('braspag_protectedcard/transaction_command_authorize_creditCardJustClick')
    ...
    public function capture(Varien_Object $payment, $amount)
    {
        ...
        Mage::getSingleton('braspag/pagador/method_transaction_cc_command_captureCommand')->execute();
    ...
    public function void(Varien_Object $payment)
    {
        ...
        Mage::getSingleton('braspag/pagador/method_transaction_cc_command_voidCommand')->execute();
    ...
    public function refund(Varien_Object $payment, $amount)
    {
        ...
        Mage::getSingleton('braspag/pagador/method_transaction_cc_command_refundCommand')->execute();
