 ...
 */
class Braspag_PaymentSplit_Model_Transaction_Resource_Authorize_CreditCard_Request_Handler_PaymentSplit
extends Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Request_Handler
{
    /**
     * @param $payment
     * @param $request
