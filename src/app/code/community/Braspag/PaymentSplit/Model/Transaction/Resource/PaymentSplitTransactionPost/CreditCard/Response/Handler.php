 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_PaymentSplit_Model_Transaction_Resource_PaymentSplitTransactionPost_CreditCard_Response_Handler
extends Braspag_Pagador_Model_Transaction_AbstractHandler
{
    ...
    {
        $splitPaymentData = $response->getSplitPayments();
