 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_PaymentSplit_Model_Transaction_Resource_PaymentSplitTransactionPost_DebitCard_Request_Builder
    extends Braspag_Pagador_Model_Transaction_AbstractBuilder
{
    ...
    public function build($order, $payment)
    {
        ...
        $splitPaymentsBuilder = Mage::getModel('braspag_paymentsplit/transaction_resource_paymentSplitTransactionPost_debitCard_request_builder_splitPayments');
