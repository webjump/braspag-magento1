 ...
 */
class Braspag_PaymentSplit_Model_Transaction_Resource_Authorize_CreditCard_Request_Processor_PaymentSplit
extends Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Request_Processor
{
    /**
     * @param $payment
     * @param $request
