 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_AntiFraud_Model_Transaction_Resource_Authorize_CreditCard_Response_Processor_AntiFraud
extends Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Response_Processor
{
    /**
     * @param $payment
     * @param $response
     * @return $this|Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Response_Processor
     */
