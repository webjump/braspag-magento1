 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Auth3ds20_Model_Mpi extends Mage_Core_Model_Abstract
{
    /**
     * @return mixed
     * @throws Exception
            ...
            if ($errors = $result->getErrorReport()->getErrors()) {
				...
				foreach ($errors AS $error) {
                    ...
                    foreach ($error as $errorDetail) {
                        $error_msg[] = Mage::helper('braspag_paymentsplit')->__('* Error: %1$s (code %2$s)', $errorDetail->Message, $errorDetail->Code);
                    }
				}
