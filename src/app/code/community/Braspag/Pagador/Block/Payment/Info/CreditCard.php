 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Block_Payment_Info_CreditCard extends Braspag_Pagador_Block_Payment_Info
{
    protected $creditCardAvailableTypes = null;

    /**
     * Braspag_Pagador_Block_Payment_Info_CreditCard constructor.
     * @param array $args
     */
    public function __construct(array $args = array())
    {
        ...
        $formChildren = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('payment/braspag_creditcard/block/info');
