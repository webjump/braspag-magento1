 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Builder_Payment
    extends Braspag_Pagador_Model_Transaction_AbstractBuilder
{
    ...
    public function build($payment, $amount)
    {
        $paymentCompositeData = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/builder/payment');
        ...
        return $paymentComposite->getData($payment, $amount);
    }
}
