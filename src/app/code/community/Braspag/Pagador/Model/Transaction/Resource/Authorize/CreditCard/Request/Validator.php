 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Request_Validator
extends Braspag_Pagador_Model_Transaction_AbstractValidator
{
    ...
    public function validate($payment, $request)
    {
        $validators = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/authorize/credit_card/request/validator');
