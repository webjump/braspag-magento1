 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Order_Boleto_Request_Builder_Payment
extends Braspag_Pagador_Model_Transaction_Builder_Payment
{
    ...
    public function build($payment, $amount)
    {
        ...
        $paymentCompositeData = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/order/boleto/request/builder/composite/payment');
        ...
        $creditCardPayment = $this->getServiceManager()->get('Pagador\Data\Request\Payment\Boleto');
