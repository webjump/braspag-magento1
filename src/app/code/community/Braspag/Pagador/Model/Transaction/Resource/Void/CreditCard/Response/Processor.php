 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Void_CreditCard_Response_Processor
extends Braspag_Pagador_Model_Transaction_AbstractProcessor
{
    ...
    public function process($payment, $response)
    {
        ...
        $processes = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/void/credit_card/response/processor');
