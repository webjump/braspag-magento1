 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Order_Boleto_Request_Builder_Order
extends Braspag_Pagador_Model_Transaction_Builder_Order
{
    ...
    public function build($payment, $amount)
    {
        ...
        $orderCompositeData = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/order/boleto/request/builder/composite/order');
