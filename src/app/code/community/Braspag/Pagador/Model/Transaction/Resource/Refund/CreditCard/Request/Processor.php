 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Refund_CreditCard_Request_Processor
    extends Braspag_Pagador_Model_Transaction_AbstractProcessor
{
    ...
    public function process($payment, $request)
    {
        $processes = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/refund/credit_card/request/processor');
