 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Void_CreditCard_Request_Builder_Payment
extends Braspag_Pagador_Model_Transaction_Builder_Payment
{
    ...
    public function build($payment, $amount)
    {
        ...
        $paymentCompositeData = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/void/credit_card/request/builder/composite/payment');
