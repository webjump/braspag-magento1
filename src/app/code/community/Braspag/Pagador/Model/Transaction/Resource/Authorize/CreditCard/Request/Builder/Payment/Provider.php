 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Request_Builder_Payment_Provider
    extends Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Request_Builder_Payment
{
    ...
    public function build($payment)
    {
        ...
        return trim(isset($providerBrand[0]) ? $providerBrand[0] : 'InvalidProvider');
    }
}
