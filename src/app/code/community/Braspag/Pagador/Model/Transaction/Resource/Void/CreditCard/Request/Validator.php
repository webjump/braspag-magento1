 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Void_CreditCard_Request_Validator
extends Braspag_Pagador_Model_Transaction_AbstractValidator
{
    ...
    public function validate($payment, $request)
    {
        $validators = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/void/credit_card/request/validator');
