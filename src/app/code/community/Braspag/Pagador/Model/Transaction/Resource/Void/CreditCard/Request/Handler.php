 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Void_CreditCard_Request_Handler
    extends Braspag_Pagador_Model_Transaction_AbstractHandler
{
    ...
    public function handle($payment, $request)
    {
        $handlers = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/void/credit_card/request/handler');
