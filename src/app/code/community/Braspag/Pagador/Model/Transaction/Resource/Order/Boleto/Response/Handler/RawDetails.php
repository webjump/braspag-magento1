 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Order_Boleto_Response_Handler_RawDetails
extends Braspag_Pagador_Model_Transaction_Resource_Order_Boleto_Response_Handler
{
    /**
     * @param $payment
     * @param $response
     * @return $this|Braspag_Pagador_Model_Transaction_Resource_Order_Boleto_Response_Handler
     */
