 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Capture_CreditCard_Response_Handler
extends Braspag_Pagador_Model_Transaction_AbstractHandler
{
    ...
    public function handle($payment, $response)
    {
        ...
        $handlers = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/capture/credit_card/response/handler');
