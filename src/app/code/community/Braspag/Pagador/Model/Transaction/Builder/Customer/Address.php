 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Builder_Customer_Address
    extends Braspag_Pagador_Model_Transaction_Builder_Customer
{
    ...
    public function build($payment, $amount)
    {
        ...
        $customerAddressCompositeData = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/builder/customer/composite/address');
        ...
        $addressData = $customerAddressComposite->getAllAddressData($billingAddress, $abbreviation);
