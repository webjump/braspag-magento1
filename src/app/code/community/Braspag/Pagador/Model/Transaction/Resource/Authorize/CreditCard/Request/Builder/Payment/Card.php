 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Request_Builder_Payment_Card
    extends Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Request_Builder_Payment
{
    ...
    public function build($payment, $amount)
    {
        ...
        $paymentCardCompositeData = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/authorize/credit_card/request/builder/composite/payment/composite/card');
