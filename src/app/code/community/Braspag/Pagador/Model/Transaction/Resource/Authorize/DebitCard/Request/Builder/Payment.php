 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Authorize_DebitCard_Request_Builder_Payment
extends Braspag_Pagador_Model_Transaction_Builder_Payment
{
    ...
    public function build($payment, $amount)
    {
        ...
        $paymentCompositeData = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/authorize/debit_card/request/builder/composite/payment');
        ...
        $creditCardPayment = $this->getServiceManager()->get('Pagador\Data\Request\Payment\DebitCard');
