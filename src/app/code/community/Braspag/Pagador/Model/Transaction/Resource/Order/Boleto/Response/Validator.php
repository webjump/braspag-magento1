 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Order_Boleto_Response_Validator
extends Braspag_Pagador_Model_Transaction_AbstractValidator
{
    ...
    public function validate($response)
    {
        ...
        $validators = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/order/boleto/response/validator');
