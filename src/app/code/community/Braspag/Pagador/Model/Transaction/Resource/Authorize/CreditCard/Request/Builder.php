 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Transaction_Resource_Authorize_CreditCard_Request_Builder
    extends Braspag_Pagador_Model_Transaction_AbstractBuilder
{
    ...
    public function build($payment, $amount)
    {
        ...
        $requestBuilderCompositeData = $this->getBraspagCoreConfigHelper()
            ->getDefaultConfigClassComposite('braspag_pagador/transaction/command/authorize/credit_card/request/builder');
