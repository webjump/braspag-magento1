 ...
 * @link      http://www.webjump.com.br
 **/
class Braspag_Pagador_Model_Method_Creditcard
    extends Braspag_Pagador_Model_Method_Abstract
{
    protected $_code = Braspag_Pagador_Model_Config::METHOD_CREDITCARD;
    ...
    public function assignData($data)
    {
        ...
        if ($this->getCode() != Braspag_Pagador_Model_Config::METHOD_CREDITCARD) {
    ...
    public function getCreditCardAvailableTypes()
    {
        ...
        $creditcardConfig = Mage::getModel('braspag_pagador/config_transaction_creditCard');
        $availableTypes = $creditcardConfig->getAvailableCreditCardPaymentMethods();
        ...
        foreach ($availableTypes as $availableType) {
            ...
            $creditCardTypes[!empty($brand) ? $acquirerCode.'-'.$brand : $acquirerCode] = (empty($acquirers[$acquirerCode]) ? $acquirerCode : $acquirers[$acquirerCode]." - ").$brand;
        }
    ...
    public function authorize(Varien_Object $payment, $amount)
    {
        ...
        Mage::getModel('braspag_pagador/transaction_command_authorize_creditCard')
            ->execute($payment, $amount);
    ...
    public function capture(Varien_Object $payment, $amount)
    {
        ...
        Mage::getModel('braspag_pagador/transaction_command_capture_creditCard')
            ->execute($payment, $amount);
    ...
    public function void(Varien_Object $payment)
    {
        ...
        Mage::getModel('braspag_pagador/transaction_command_void_creditCard')
            ->execute($payment);
    ...
    public function refund(Varien_Object $payment, $amount)
    {
        ...
        Mage::getModel('braspag_pagador/transaction_command_refund_creditCard')
            ->execute($payment, $amount);
