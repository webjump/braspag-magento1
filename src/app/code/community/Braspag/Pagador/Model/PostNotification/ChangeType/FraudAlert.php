...
class Braspag_Pagador_Model_PostNotification_ChangeType_FraudAlert
    ...
    implements Braspag_Pagador_Model_PostNotification_ChangeTypeInterface
{
    ...
    {
        return Braspag_Pagador_Model_PostNotification_ChangeTypeInterface::POST_NOTIFICATION_CHANGE_TYPE_FRAUD_ALERT;
    }
