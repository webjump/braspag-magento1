...
class Braspag_Pagador_Model_PostNotification_ChangeType_RecurrenceCreated
    ...
    implements Braspag_Pagador_Model_PostNotification_ChangeTypeInterface
{
    ...
    {
        return Braspag_Pagador_Model_PostNotification_ChangeTypeInterface::POST_NOTIFICATION_CHANGE_TYPE_RECURRENCE_CREATED;
    }
