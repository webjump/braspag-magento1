 ...
 * @link      http://www.webjump.com.br
 **/
class Webjump_BraspagPagador_Model_Pagador_Creditcard_Resource_Capture_RequestBuilder
{
    /**
     * @param $payment
     * @param $amount
    ...
    public function build($payment, $amount)
    {
        ...
        $paymentData = Mage::getModel('webjump_braspag_pagador/pagador_creditcard_resource_capture_paymentBuilder')
