 ...
 * @link      http://www.webjump.com.br
 **/
class Webjump_BraspagPagador_Model_Pagador_Debitcard_Resource_Authorize_RequestBuilder
{
    /**
     * @param $payment
     * @param $amount
    ...
    public function build($payment, $amount)
    {
        ...
        $paymentData = Mage::getModel('webjump_braspag_pagador/pagador_Debitcard_resource_Authorize_paymentBuilder')
            ->build($payment, $amount, 'Debitcard');
