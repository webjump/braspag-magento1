...
// * @link      http://www.webjump.com.br
// **/
//class Webjump_BraspagPagador_Model_Pagador_Transaction_Debitcard_Resource_Authorize_ResponseBuilder
//{
//    protected $_apiType = 'webjump_braspag_pagador/pagador_transaction_Authorize_Debitcard';
//    protected $request;
//
//    protected $payment;
//    protected $amount;
...
////    {
////        $result = $this->getPagador()->order($payment, $amount);
////
////        $this->_importOrderResultToPayment($result, $payment, $result->getPayment()->get());
////
...
////     * @return $this
////     */
////    protected function _importOrderResultToPayment($result, $payment, $resultPayment)
////    {
...
////
////            $this->processOrderInfoData($resultData['payment']);
////
////            if ($antiFraudConfig->isAntifraudActive()
////                && $fraudAnalysisStatus = $resultPayment->getFraudAnalysis()['Status']
////            ) {
////                $payment = $this->getOrderFraudAnalysis($fraudAnalysisStatus, $payment);
////            }
////        }
////
...
////            $this->errorMsg[] = $this->getHelper()->__('The payment was unorderd.');
////        }
////
////        $payment
...
////
////        $this->processOrderRawDetails($resultData['payment'], $payment);
////        $this->processOrderErrors($payment);
////
////        return $this;
////    }
////
...
////     * @return mixed
////     */
////    protected function getOrderFraudAnalysis($fraudAnalysisStatus, $payment)
////    {
////        $antiFraudConfig = Mage::getModel('webjump_braspag_pagador/config_antifraud');
////
