 ...
 * @link      http://www.webjump.com.br
 **/
class Webjump_BraspagPagador_Model_Pagador_Creditcard_Resource_Authorize_Request_Validator
{
    ...
    protected function validateType($paymentRequest)
    {
        if ((isset($paymentRequest['cc_type'])) &&
            (!$this->getCreditCardPaymentMethod()->getCreditCardAvailableTypesLabelByCode($paymentRequest['cc_type']))
        ) {
