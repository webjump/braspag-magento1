 ...
 * @link      http://www.webjump.com.br
 **/
class Webjump_BraspagPagador_Model_Pagador_Creditcard_Resource_Refund_Response_Validator
{
    /**
    ...
    public function validate($response)
    {
        ...
        if (
            $paymentDataResponse->getStatus() != Webjump_BrasPag_Pagador_TransactionInterface::TRANSACTION_STATUS_REFUNDED
