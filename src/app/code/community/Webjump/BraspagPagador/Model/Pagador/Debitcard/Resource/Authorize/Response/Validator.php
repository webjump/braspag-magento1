 ...
 * @link      http://www.webjump.com.br
 **/
class Webjump_BraspagPagador_Model_Pagador_Debitcard_Resource_Authorize_Response_Validator
{
    /**
    ...
    public function validate($response)
    {
        ...
        if (in_array($paymentDataResponse->getStatus(), [
            ...
            || (!$paymentDataResponse->getAuthenticationUrl() && $paymentDataResponse->getStatus()
                == Webjump_BrasPag_Pagador_TransactionInterface::TRANSACTION_STATUS_NOT_FINISHED
            )
        ) {
            throw new Exception("(Code {$paymentDataResponse->getProviderReturnCode()}) "
                .$paymentDataResponse->getProviderReturnMessage());
        }
